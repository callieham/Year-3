...
```{r}
file_path <- "/Users/calam/Desktop/Year 3/Applied Stats Inference/elife-59399-fig1-data1-v2.xlsx"
...
To match with the notation used throughout the module, we'll define the response variable as $y$:
